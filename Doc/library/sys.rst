...
.. data:: flags
   ...
   The :const:`jit_control` flag is specific to Unladen Swallow 2009Q2 and
   above. The :const:`generate_debug_info` flag is specific to Unladen Swallow
   2009Q3 and above.
