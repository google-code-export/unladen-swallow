...
I sent this model out in May 2008, but didn't get many responses. For now, Unladen Swallow will follow the rules under "The rules for Python", and primarily "Atomic, unordered assignments" from the optional rules. These may change over time as we try to align with other implementations and find what rules have what performance implications.
...
.. [#JMM-popl] The Java Memory Model, by Jeremy Manson, Bill Pugh, and
   Sarita Adve
   (http://unladen-swallow.googlecode.com/files/journal.pdf). This paper
